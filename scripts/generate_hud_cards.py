...
def generate_hud_svg(output_path="assets/metrics_hud.svg"):
    ...
    stats = [
        ...
        ("ARCHITECTURE", "16+ MODULES", "Multi-Tenant SaaS ERP", "#38BDF8"),
    ...
    for i, (label, val, desc, color) in enumerate(stats):
        ...
        svg.append(f'    <rect x="0" y="0" width="{card_w}" height="{card_h}" rx="8" fill="#0A101F" stroke="#1E293B" stroke-width="1.2" />')
